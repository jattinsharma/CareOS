...
// FCM VAPID public key. Safe to ship in client code — it's public by design
// (the matching PRIVATE key stays in the Firebase console and must never be
// committed). The env var takes precedence so it can still be overridden per
// environment, but tokens work without any env config now.
const VAPID_KEY =
  process.env.NEXT_PUBLIC_FIREBASE_VAPID_KEY ||
  "BM03MxpPJQXWp55FwGAKp-m5_Z-54JYShgwdg6q8C2wqI4kL00sx3e7dd3Ee-P2ef51NKHUGlkbDG6q4E7V8Js4";
